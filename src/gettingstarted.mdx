...
import * as GettingStarted from "./gettingstarted.stories.tsx";
...
Resulting in...
<Canvas of={GettingStarted.FirstExample}/>
...
<Canvas of={GettingStarted.SecondExample}/>
...
```
<Canvas of={GettingStarted.ThirdExample}/>
